...
def main(argv):
    # StepB: goes back in here and call prepare from experiment.py
    # This step merges the 2 yaml file: data yaml and model yaml
...
# Here without passing help, it calls main(sys.argv)
# passing all of my CLI arguents as a list, and CLU arguments is represented by argv
