---
experiment_id: "gpu___archive__toggle_cellot_subdirs__toggle_m2_iid__cellot"
run_id: "gpu/_archive/toggle_cellot_subdirs/toggle_m2_iid/cellot"
...
# gpu/_archive/toggle_cellot_subdirs/toggle_m2_iid/cellot
...
| Metric | Value |
|---|---|
| R² (means, squared) | 0.9445 |
| MMD | 0.0192 |
| n_cells present | 100 |

## On-disk references (HPC)

- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/_archive/toggle_cellot_subdirs/toggle_m2_iid/cellot`
- Rich card (figures, HPC-only): `docs/model_cards/gpu___archive__toggle_cellot_subdirs__toggle_m2_iid__cellot.md`
