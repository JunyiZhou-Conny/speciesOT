---
experiment_id: "gpu___archive__toggle_cellot_subdirs__toggle_m4_ood__cellot"
run_id: "gpu/_archive/toggle_cellot_subdirs/toggle_m4_ood/cellot"
...
# gpu/_archive/toggle_cellot_subdirs/toggle_m4_ood/cellot
...
| Metric | Value |
|---|---|
| R² (means, squared) | 0.4942 |
| MMD | 0.1109 |
| n_cells present | 10, 20, 30 |

## On-disk references (HPC)

- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/_archive/toggle_cellot_subdirs/toggle_m4_ood/cellot`
- Rich card (figures, HPC-only): `docs/model_cards/gpu___archive__toggle_cellot_subdirs__toggle_m4_ood__cellot.md`
