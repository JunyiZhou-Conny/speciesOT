---
experiment_id: "gpu__hvg_cell_ranger_a_ood__impact_cellot"
run_id: "gpu/hvg_cell_ranger_a_ood/impact_cellot"
...
# gpu/hvg_cell_ranger_a_ood/impact_cellot

**IMPACT_CellOT** · status `done` · holdout `CL:0000625` · mode `ood`

**Sibling in this experiment:** [[gpu__hvg_cell_ranger_a_ood__scgen]]
...
- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/hvg_cell_ranger_a_ood/impact_cellot`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__hvg_cell_ranger_a_ood__impact_cellot.md`
