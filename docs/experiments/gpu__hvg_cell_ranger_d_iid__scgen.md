---
experiment_id: "gpu__hvg_cell_ranger_d_iid__scgen"
run_id: "gpu/hvg_cell_ranger_d_iid/scgen"
family: "scgen"
status: "done"
...
# gpu/hvg_cell_ranger_d_iid/scgen

**scGen** · status `done` · holdout `CL:0000624` · mode `iid`

**Sibling in this experiment:** [[gpu__hvg_cell_ranger_d_iid__impact_cellot]]
...
- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/hvg_cell_ranger_d_iid/scgen`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__hvg_cell_ranger_d_iid__scgen.md`
