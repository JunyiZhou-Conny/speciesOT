---
experiment_id: "gpu__hvg_pearson_residuals_d_ood__scgen"
run_id: "gpu/hvg_pearson_residuals_d_ood/scgen"
family: "scgen"
status: "done"
...
# gpu/hvg_pearson_residuals_d_ood/scgen

**scGen** · status `done` · holdout `CL:0000624` · mode `ood`

**Sibling in this experiment:** [[gpu__hvg_pearson_residuals_d_ood__impact_cellot]]
...
- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/hvg_pearson_residuals_d_ood/scgen`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__hvg_pearson_residuals_d_ood__scgen.md`
