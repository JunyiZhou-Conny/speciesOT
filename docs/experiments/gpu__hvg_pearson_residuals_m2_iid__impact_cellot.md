---
experiment_id: "gpu__hvg_pearson_residuals_m2_iid__impact_cellot"
run_id: "gpu/hvg_pearson_residuals_m2_iid/impact_cellot"
...
# gpu/hvg_pearson_residuals_m2_iid/impact_cellot

**IMPACT_CellOT** · status `done` · holdout `CL:0000875, CL:0000576` · mode `iid`

**Sibling in this experiment:** [[gpu__hvg_pearson_residuals_m2_iid__scgen]]
...
- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/hvg_pearson_residuals_m2_iid/impact_cellot`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__hvg_pearson_residuals_m2_iid__impact_cellot.md`
