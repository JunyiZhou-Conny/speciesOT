---
experiment_id: "gpu__toggle_m1_ood__impact"
run_id: "gpu/toggle_m1_ood/impact"
...
# gpu/toggle_m1_ood/impact

**IMPACT_CellOT** · status `done` · holdout `CL:0000875` · mode `ood`

**Sibling in this experiment:** [[gpu__toggle_m1_ood__scgen]]
...
| Metric | Value |
|---|---|
| R² (means, squared) | 0.7313 |
| MMD | 0.0357 |
| n_cells present | 100 |

## On-disk references (HPC)

- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/toggle_m1_ood/impact`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__toggle_m1_ood__impact.md`
