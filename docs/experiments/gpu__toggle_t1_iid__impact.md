---
experiment_id: "gpu__toggle_t1_iid__impact"
run_id: "gpu/toggle_t1_iid/impact"
...
# gpu/toggle_t1_iid/impact

**IMPACT_CellOT** · status `done` · holdout `CL:0000625` · mode `iid`

**Sibling in this experiment:** [[gpu__toggle_t1_iid__scgen]]
...
| Metric | Value |
|---|---|
| R² (means, squared) | 0.8671 |
| MMD | 0.0219 |
| n_cells present | 25, 50, 80 |

## On-disk references (HPC)

- Model dir: `/n/holylabs/mooney_lab/Lab/junyizhou/speciesOT/cellot/cellot_gpu/results/toggle_t1_iid/impact`
- Rich card (figures, HPC-only): `docs/model_cards/gpu__toggle_t1_iid__impact.md`
